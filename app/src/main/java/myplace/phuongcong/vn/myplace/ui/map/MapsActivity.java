...
public class MapsActivity extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks,
        ...
        OnMapReadyCallback, LocationListener, MapView {
    ...
    @Override
    public void onLoadListLocationSuccess(ArrayList<MyLocation> myLocations) {
        for (MyLocation myLocation : myLocations) {
            LatLng l = new LatLng(myLocation.getLat(), myLocation.getLng());
            MarkerOptions markerOptions = new MarkerOptions();
    ...
    public void onViewClicked() {
        String seachText=editText.getText().toString().trim();
    ...
    private void buildDialog(int dialogTheme, Address address, LatLng latLng) {
        String countryName=address.getCountryName();
        String featureName=address.getFeatureName();
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Animation Dialog");
        builder.setMessage(countryName+" "+featureName);
        builder.setNegativeButton("OK", null);
        AlertDialog dialog = builder.create();
        dialog.getWindow().getAttributes().windowAnimations = dialogTheme;
        dialog.show();
    }
